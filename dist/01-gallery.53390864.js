...
// Завдання 8.1.2
const galleryMarkup = (0, _galleryItems.galleryItems).map(({ original , preview , description  })=>`
...
const lightboxGallery = new (0, _simplelightboxDefault.default)(".gallery a", lightboxOptions);
